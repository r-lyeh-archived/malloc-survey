...
#define BA_WALK_CHUNKS3(p, h, l, label, ...)  do {			\
...
#define BA_WALK_CHUNKS2(p, h, l, label, ...)  BA_WALK_CHUNKS3(p, h, l, label, __VA_ARGS__)
#define BA_WALK_CHUNKS(p, h, l, ...) BA_WALK_CHUNKS2(p, h, l, XCONCAT(chunk_loop_label, __LINE__), __VA_ARGS__)
